...
define_side_metadata_specs!(
    ...
    // Keep track of the largest hole within a block
    IX_BLOCK_LARGE_HOLE_STATUS   = (global: false, log_num_of_bits: 3, log_bytes_in_region: crate::policy::immix::block::Block::LOG_BYTES),
    IX_BLOCK_LARGE_HOLE_SIZE   = (global: false, log_num_of_bits: 3, log_bytes_in_region: crate::policy::immix::block::Block::LOG_BYTES),
