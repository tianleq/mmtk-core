...
define_side_metadata_specs!(
    ...
    // Keep track of blocks' allocated/live bytes
    IX_BLOCK_BYTES_UTILIZATION = (global: false, log_num_of_bits: 5, log_bytes_in_region: crate::policy::immix::block::Block::LOG_BYTES),
    // Keep track of blocks' allocated/live lines
    IX_BLOCK_LINE_UTILIZATION = (global: false, log_num_of_bits: 5, log_bytes_in_region: crate::policy::immix::block::Block::LOG_BYTES),
